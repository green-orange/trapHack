...
defMountainCnt, defFlatHeight, defRiverCnt, defSwampDepth, defBonfireCnt, defMagicCnt,
	defSinesCnt, defTrapCnt, defHillCnt, defVoronoi :: Int
defMountainCnt = 1200
defFlatHeight = 9
defRiverCnt = 50
defSwampDepth = 3
...
customMapChoice = do
	...
	putStrLn "g - map generated using Voronoi diagrams"
	heigenStr <- getLine
	...
	when (heigenStr == "e") $ putStrLn $ "Put number of hills (default: " ++
		show defHillCnt ++ ")"
	when (heigenStr == "g") $ putStrLn $ "Put number of regions in Voronoi diagram (default: " ++
		show defVoronoi ++ ")"
	hei <- if heigenStr `elem` ["a", "c", "d", "e", "g"] then getLine else return ""
	...
	where
		...
		heigen str1 str2 = case str1 of
			...
			"f" -> DiamondSquare
			"g" -> Voronoi $ maybeReadNum defVoronoi str2
			_ -> Sines defSinesCnt
		avg = maybeReadNum 0
